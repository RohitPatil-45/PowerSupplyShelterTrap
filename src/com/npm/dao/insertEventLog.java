        ...
        try (Connection connection = Datasource.getConnection();
            ...
            for (EventLog log : SnmpTrapListener.insertEventLogListTemp) {
                ...
                try {
                    ...
                    e.printStackTrace();
                    System.out.println("update error: " + log.getDeviceId());
                    System.out.println("update error: " + log.getAlarmStatus());
                    System.out.println("update error: " + log.getServiceId());
                    System.out.println("update error: " + log.getServiceName());
                }
                try {
...
//                    }
                    ...
                    e.printStackTrace();
                    System.out.println("Insert error: " + log.getDeviceId());
                    System.out.println("Insert error: " + log.getAlarmStatus());
                    System.out.println("Insert error: " + log.getServiceId());
                    System.out.println("Insert error: " + log.getServiceName());
                }
            }
//            try {
//                preparedStatement.executeBatch();
